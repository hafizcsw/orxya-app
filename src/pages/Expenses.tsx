  ...
  return (
    <div className="min-h-screen bg-background p-4 pb-24">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">الأكثر إنفاقاً</p>
          ...
          <Card className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">${dailyAverage.toFixed(2)}</p>
              </div>
            </div>
          </Card>
        </div>
        ...
        {chartData.length > 0 && (
          <Card className="p-6">
            <h2 className="text-xl font-bold mb-4 text-foreground">توزيع المصروفات</h2>
        ...
        <div className="space-y-3">
          <h2 className="text-xl font-bold text-foreground">قائمة المصروفات</h2>
          {loading ? (
