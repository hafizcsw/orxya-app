...
const sheetVariants = cva(
  "fixed gap-4 bg-background shadow-2xl transition-all ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 z-[var(--z-modal)]",
  {
    variants: {
      side: {
